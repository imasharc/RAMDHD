...
namespace RAMDHD.Views.MainScreens.Attention.Flashcards.Challenging.Sample;

public partial class SampleChallengesFlashcardsPage : ContentPage
{
    ...
    public SampleChallengesFlashcardsPage()
    {
        ActivePage = 0;
        InitializeComponent();
        BindingContext = this;
    ...
    {
        flashcards = SampleChallengesFlashcardsRepository.GetFlashcards();
